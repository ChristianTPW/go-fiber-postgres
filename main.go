...
import (
	...
	"github.com/christiantpw/go-fiber-postgres/models"
	"github.com/christiantpw/go-fiber-postgres/storage"
...
func (r *Repository) GetBooks(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(&fiber.Map{"message" : "books fetched succesfully", "data": bookModels})
